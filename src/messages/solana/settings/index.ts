...
export const getSettings = async (
    ...
    const caption =
        ...
        `${await t('settings.p2', userId)}\n <a href="${userChain === "ethereum" ? "https://the-cryptofox-learning.com/api/wiki_sections.php?action=gate&wiki=eth&section=parametres&sig=w3vgazUPg2d7w1pjApMx__eHhEiiWK23" : "https://the-cryptofox-learning.com/api/wiki_sections.php?action=gate&wiki=sol&section=parametres&sig=N4KrgoYgBBbfL0AuWQXs7be84biuUz0I"}">${await t('settings.p3', userId)}</a>\n\n` +
