...
export const en: Translations = {
    ...
    admin: {
        ...
        withdrawLockoutAttempts: "Withdraw 2FA lockout after N fails",
        withdrawLockoutMinutes: "Withdraw 2FA lockout duration (min)",
    },
    ...
    // TOTP 2FA (keys kept as pin.* for i18n paths)
    pin: {
        setPin: "🔐 Set up 2FA",
        changePin: "🔐 Change 2FA",
        setPinFirst: "2FA required",
        setPinFirstDesc: "You must set up two-factor authentication (authenticator app) in Settings (below Auto Sell) before you can export a private key or confirm withdrawals. Tap Settings below to open Settings and set up 2FA.",
        enterNewPin: "Scan the QR code we sent, then enter the 6-digit code from your app:",
        enterCurrentPin: "Enter the 6-digit code from your authenticator app:",
        enterPinToExport: "Enter the 6-digit code from your authenticator app to export this wallet's private key:",
        wrongPin: "❌ Wrong code. Try again.",
        pinSetSuccess: "✅ 2FA is enabled. Withdrawals and private key export are now protected.",
        pinChangedSuccess: "✅ 2FA was changed successfully.",
        pinMustBeDigits: "Enter a valid 6-digit code from your authenticator app.",
        ...
        setupEnterCode: "Then reply with the 6-digit code from your app to verify:",
        cancelSetup: "❌ Cancel setup",
        invalidTotpFormat: "That must be exactly 6 digits. Try again.",
        setupHelpPrompt: "❓ Need more help?",
        setupHelpLink: "Click Here!",
    },
    ...
    withdrawal: {
        ...
        enterPin: "Enter the 6-digit code from your authenticator app to continue.",
        sendNow: "Send now",
        finalReview: "💸 Final review — verify the destination address",
        lockedUntil: "2FA entry locked. Try again after:",
        pinLockoutExceeded:
            "Too many wrong codes ({attempts}). Wait {minutes} minutes before trying again.",
        pinLockoutStillLocked: "2FA is temporarily locked. Try again in about {minutes} minute(s).",
    ...
    messages: {
        ...
        adminWithdrawLockoutAttempts: "Enter failed 2FA attempts before lockout (1–20):",
        adminWithdrawLockoutMinutes: "Enter 2FA lockout duration in minutes (1–1440):",
