...
export const fr: Translations = {
    ...
    admin: {
        ...
        walletSolanaLimit: "Limite portefeuilles Solana (création + import)",
        walletEthereumLimit: "Limite portefeuilles Ethereum (création + import)",
    ...
    referral: {
        ...
        listTitle: "📋 Votre liste de parrainages",
        totalReferrals: "Total des parrainages",
        noReferrals: "Vous n'avez encore parrainé personne. Partagez votre lien de parrainage pour commencer à gagner !",
    ...
    menu: {
        ...
        p3_ethereum: 'Gérez votre crypto Ethereum plus rapidement que jamais avec des achats et des ventes instantanés, un suivi en temps réel de vos positions et un contrôle total de votre portefeuille directement depuis Telegram.',
        ...
        p5_ethereum: "Bénéficiez de transactions sécurisées, de prix en direct et de frais réduits pour optimiser chaque mouvement sur la blockchain Ethereum.",
    ...
    wallets: {
        ...
        p2: "Votre portefeuille Solana ou Ethereum :",
        p2_solana: "Votre portefeuille Solana :",
        p2_ethereum: "Votre portefeuille Ethereum :",
        p3: "❓ Besoin de plus d'aide ?",
        p4: "Cliquez ici !",
        p5: "⬇️ Créez, gérez et importez des portefeuilles ici.",
        p6: "📚 Vos portefeuilles Solana ou Ethereum",
        p6_solana: "📚 Vos portefeuilles Solana",
        p6_ethereum: "📚 Vos portefeuilles Ethereum",
    ...
    trending: {
        ...
        p9: "💰 Prix",
        viewOnDexscreener: "📊 Voir sur Dexscreener",
        next: "⏭️ Suivant",
    ...
    messages: {
        ...
        walletLimitSolana: "Saisissez le nombre max de portefeuilles Solana par utilisateur (création + import), 1-100 :",
        walletLimitEthereum: "Saisissez le nombre max de portefeuilles Ethereum par utilisateur (création + import), 1-100 :",
    ...
    errors: {
        ...
        walletLimitSolana: "❌ Limite de portefeuilles Solana atteinte. Vous ne pouvez pas créer ou importer plus de",
        walletLimitEthereum: "❌ Limite de portefeuilles Ethereum atteinte. Vous ne pouvez pas créer ou importer plus de",
    ...
    bundleWallets: {
        ...
        cleanFundDesc_ethereum: "Cela récupérera tout ETH restant des portefeuilles temporaires utilisés pendant le financement.",
