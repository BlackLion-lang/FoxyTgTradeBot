...
export const fr: Translations = {
    ...
    admin: {
        ...
        removeUser: "Suppr utilisateur",
        addSniperUser: "Ajouter utilisateur Sniper",
        removeSniperUser: "Supprimer utilisateur Sniper",
        ...
        languageEn: "Anglais",
        languageFr: "Français",
        withdrawFreshDays: "Jours Wallet « Récent » (Limit J.)",
        withdrawDailyLimitSol: "Limit J. SOL (Wallets récents)",
        withdrawDailyLimitEth: "Limit J. ETH (Wallets récents)",
        withdrawCooldownMins: "Délai 1er retrait (Min 0 = Désactivé)",
        withdrawLockoutAttempts: "Verrou. 2FA après N échecs",
        withdrawLockoutMinutes: "Durée verrou. 2FA (Min)",
    },
    ...
    pnl: {
        ...
        solanaOnly: "Solana uniquement — Basé sur l’historique enregistré par FoxyBoTracker.",
        period: "Période",
        periodTag_1d: "1 jour",
        periodTag_7d: "7 jours",
        periodTag_30d: "30 jours",
        periodTag_all: "Tout",
        btn1d: "1J",
        btn7d: "7J",
        btn30d: "30J",
        btnAll: "Tout",
        totalPnl: "PNL total (Estimé.)",
        periodDelta: "Variation PNL",
        realizedClosed: "Réalisé (Positions fermées)",
        unrealizedOpen: "Positions ouvertes (Dont MTM au dernier prix BOT)",
        activityInPeriod: "Activité sur cette période",
        trades: "Trades",
        volume: "Volume (USD Estimé.)",
        fees: "Frais / Tips (Estimé.)",
        winRate: "Taux de réussite",
        winRateHint: "Tokens fermés uniquement",
        bestTrade: "Plus grosse vente (USD)",
        worstTrade: "Plus petite vente (USD)",
        byWallet: "Par Wallet",
        byChain: "Par chaîne",
        topWinners: "Meilleurs Tokens (PNL)",
        topLosers: "Pires Tokens (PNL)",
        disclaimer:
            "Chiffres estimatifs. Les Trades hors BOT (Exemple : Phantom, MetaMask, Solflare...) ne sont pas inclus. Utilisez Effacer l’historique si les données semblent fausses.",
        refresh: "🔄 Actualiser",
        clearHistory: "🗑 Effacer l’historique",
        clearConfirm:
            "<b>Supprimer tout l’historique Solana</b> pour chaque Wallet du BOT ?\n\nLes stats PNL seront remises à zéro. Irréversible.",
        clearYes: "✅ Supprimer",
        clearNo: "↩️ Annuler",
        cleared: "Historique effacé.",
        ethereumNotSupported: "Le menu PNL est disponible sur Solana uniquement. Changez de chaîne dans le menu.",
    },
    ...
    sell: {
        ...
        autoStatusDevSell: "Vente auto si Dev Sell :",
    ...
    dangerZoneMessage: {
        ...
        p3: "Toute personne",
        p4: "ayant accès à cette clé peut accéder à votre Wallet, transférer vos fonds et effectuer des Transactions sans votre autorisation. Un code à deux facteurs (Application d’authentification) vous sera demandé pour confirmer l’exportation.",
    ...
    // 2FA TOTP (clés conservées pin.* pour les chemins i18n)
    pin: {
        setPin: "🔐 Activer la 2FA",
        changePin: "🔐 Changer la 2FA",
        setPinFirst: "2FA requise !",
        setPinFirstDesc: "Vous devez configurer l’authentification à deux facteurs (Application d’authentification) dans les Paramètres avant d’exporter une clé privée ou de confirmer un retrait. Ouvrez les Paramètres ci-dessous pour activer la 2FA.",
        enterNewPin: "Scannez le QR code envoyé, puis saisissez le code à 6 chiffres de votre application :",
        enterCurrentPin: "Saisissez le code à 6 chiffres de votre application d’authentification :",
        enterPinToExport: "Saisissez le code à 6 chiffres pour exporter la clé privée de ce Wallet :",
        wrongPin: "❌ Code incorrect. Réessayez.",
        pinSetSuccess: "✅ 2FA activée. Les retraits et l’export de clé privée sont protégés.",
        pinChangedSuccess: "✅ 2FA modifiée avec succès.",
        pinMustBeDigits: "Saisissez un code à 6 chiffres valide depuis votre application.",
        removePin: "🔓 Désactiver la 2FA",
        pinRemovedSuccess: "✅ 2FA désactivée. Les retraits et l’export ne demanderont plus de code.",
        pinOptions: "La 2FA est activée. Que souhaitez-vous faire ?",
        pinOptionsLockoutNote:
            "Pour les retraits et l’export de clé privée, jusqu’à {attempts} code(s) incorrect(s) d’affilée sont autorisés avant un verrouillage temporaire de la saisie 2FA.",
        setupTitle: "🔐 Configurer la 2FA",
        setupScanHint: "Scannez le QR code ci-dessus avec votre application (Google Authenticator, Authy, etc.).",
        setupManualLabel: "Si vous ne pouvez pas scanner, saisissez cette clé manuellement :",
        setupEnterCode: "Répondez ensuite avec le code à 6 chiffres pour vérifier :",
        cancelSetup: "❌ Annuler la configuration",
        invalidTotpFormat: "Le code doit comporter exactement 6 chiffres. Réessayez.",
        setupHelpPrompt: "❓ Besoin d'aide ?",
        setupHelpLink: "Cliquez ici !",
    },
    ...
    withdrawal: {
        ...
        enterPin: "Saisissez le code à 6 chiffres de votre application d’authentification pour continuer.",
        sendNow: "Envoyer maintenant",
        finalReview: "💸 Vérification finale — Vérifiez l'adresse de destination",
        lockedUntil: "Saisie 2FA verrouillée. Réessayez après :",
        pinLockoutExceeded:
            "Trop de codes incorrects ({attempts}). Attendez {minutes} minutes avant de réessayer.",
    ...
    copyTrade: {
        ...
        enterLabel: "Entrez le nouveau nom pour ce Wallet : ",
        ...
        ratioMenuNote:
            "Uniquement si le mode de taille est « SOL cible × ratio » : votre copie utilise le SOL dépensé par le wallet surveillé sur ce Trade, multiplié par ce nombre (1 = même taille, 0.5 = moitié).",
        ...
        summaryBlacklist: "Mints Blacklist",
        summaryWhitelist: "Mints Whitelist",
        tapModeCycle: "Mode",
        ...
        btnMinLiq: "Liq min",
        btnMinAge: "Âge min",
        btnMinVol: "Volume 24h (Min)",
        btnBlacklist: "Whitelist",
        btnWhitelist: "Blacklist",
        enterWalletPct: "Entrez le % de votre solde SOL par copie (Exemple : 5). 0–100 :",
        enterRatio: "Entrez le ratio VS le SOL du Wallet cible (Exemple : 1 = Même taille, 0.5 = Moitié). > 0 :",
    ...
    messages: {
        ...
        adminWithdrawLockoutAttempts: "Tentatives 2FA échouées avant verrouillage (1–20) :",
        adminWithdrawLockoutMinutes: "Durée du verrouillage 2FA en minutes (1–1440) :",
    ...
    bundleWallets: {
        ...
        bundleWalletExceedsMax:
            "❌ <b>Trop de Wallets</b>\n\nLe regroupement sécurisé permet de créer au maximum <b>{max}</b> Wallets à la fois. Vous avez saisi <b>{count}</b>.\n\nEntrez un entier entre <b>1</b> et <b>{max}</b>.",
        invalidWalletCount: "Nombre invalide. Utilisez un entier entre 1 et 20.",
        pleaseEnterValidNumber: "Veuillez entrer un nombre entier valide (1–20).",
